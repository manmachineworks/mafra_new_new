...
class TopBannerController extends Controller
{
    ...
    {
        $this->middleware(['permission:top_banner.index'])->only('index');
        $this->middleware(['permission:top_banner.create'])->only('create');
        $this->middleware(['permission:top_banner.create'])->only('store');
        $this->middleware(['permission:top_banner.edit'])->only('edit');
        $this->middleware(['permission:top_banner.edit'])->only('update');
        $this->middleware(['permission:top_banner.delete'])->only('destroy');
    }
