...
class UpdateController extends Controller
{
    public function step0(Request $request)
    {
        ...
        if (version_compare($current_version, '9.9', '<')) {
    ...
    {
        $versions = ['9.9'=>'v990.sql','9.9.1'=>'v991.sql', '9.9.2'=>'v992.sql', '9.9.3'=>'v993.sql', '9.9.4'=>'v994.sql', '9.9.5'=>'v995.sql', '9.9.6'=>'v996.sql','9.9.7'=>'v997.sql','9.9.8'=>'v998.sql','9.9.9'=>'v999.sql','10.0.0'=>'v1000.sql'];
