                    ...
                    @canany(['preorder_dashboard', 'add_preorder_product', 'view_all_preorder_products', 'view_all_preorders', 'view_all_inhouse_preorders', 
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                ...
                                <span class="aiz-side-nav-text">{{translate('Preorder')}} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14.001" viewBox="0 0 16 14.001" class="mx-2">
                    ...
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        @php
                                $support_ticket = DB::table('tickets')
                                                    ...
                                                    ->count();
                            @endphp
                        <span class="aiz-side-nav-text">{{translate('Support')}}&nbsp;&nbsp;@if($support_ticket > 0)<span class="badge badge-info">{{ $support_ticket
                                        }}</span>@endif</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item mm-active">
                                    <a href="#" class="aiz-side-nav-link level-3-active" aria-expanded="true">
                                        <span class="aiz-side-nav-text">Top Bar</span>
                                        <span class="aiz-side-nav-arrow"></span>
                                    </a>
                                    <!--Submenu-->
                                    <ul class="aiz-side-nav-list level-3 mm-collapse mm-show">
                                                                                    <li class="aiz-side-nav-item mm-active">
                                                <a class="aiz-side-nav-link active" href="{{ route('top_banner.index') }}" aria-expanded="true">
                                                    <span class="aiz-side-nav-text">Top Bar List</span>
                                                </a>
                                            </li>
                                                                                                                            <li class="aiz-side-nav-item">
                                                <a class="aiz-side-nav-link" href="{{ route('top_banner.setting') }}">
                                                    <span class="aiz-side-nav-text">Top Bar Settings</span>
                                                </a>
                                            </li>
                                                                            </ul>
                                </li>
