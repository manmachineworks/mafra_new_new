        ...
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
                    ...
                    <th data-breakpoints="lg">{{translate('Hot Category')}}</th>
            ...
            <tbody>
                @foreach($categories as $key => $category)
                    <tr>
                        ...
                        <td>
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" onchange="update_hot(this)" value="{{ $category->id }}" <?php if($category->hot_category == 1) echo "checked";?>>
                                <span></span>
                            </label>
                        </td>
                        @if(get_setting('seller_commission_type') == 'category_based')
