                            ...
                            <div class="w-100">
                                ...
                                <div class="customer_choice_options" id="customer_choice_options">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" placeholder="{{translate('Purchase price')}}" name="purchase_price" class="form-control @error('purchase_price') is-invalid @enderror" value="{{$product->purchase_price}}">
                                    </div>
                                </div>
                                <!-- Unit price -->
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div id="buyAnotherLinksWrapper">
                                            @php
                                                $buyAnother = old('buy_another_links', $product->buy_another_links ?? []);
                                            @endphp
