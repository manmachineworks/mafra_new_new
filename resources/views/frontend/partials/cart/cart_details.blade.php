                                    ...
                                    <li class="list-group-item px-0 border-md-0">
                                        <div class="row gutters-5 align-items-center">
                                            ...
                                            <div class="col-md col-4 ml-4 ml-sm-0 my-3 my-md-0 d-flex flex-column ml-sm-5 ml-md-0">
                                                  ...
                                                  @php $purchasePrice = $cartItem->purchase_price ?? $product->purchase_price ?? 0; @endphp
                                                <span class="fs-12 text-secondary">{{ translate('Price')}}</span>
                                                <span class="fw-700 fs-14 mb-2">
                                                    {{ cart_product_price($cartItem, $product, true, false) }}
                                                    @if($purchasePrice > 0)
                                                        <del class="ml-1 opacity-60">{{ single_price($purchasePrice) }}</del>
                                                    @endif
                                                </span>
                                                <!-- <span>
