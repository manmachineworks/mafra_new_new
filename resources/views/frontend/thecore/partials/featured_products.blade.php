...
<section class="mb-2 mb-md-2 mt-2 mt-xl-4 pr-2">
            ...
            @foreach (get_featured_products() as $key => $product)
                <div class="carousel-box mt-1 mb-1">
                    <div class="d-flex align-items-center rounded-2">
                        <!-- Image -->
                        <div class="me-3">
                            <div class="img h-50px w-50px h-sm-80px w-sm-80px overflow-hidden the-core-img position-relative image-hover-effect">
