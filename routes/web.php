...
Route::post('/webhooks/shiprocket', [ShiprocketWebhookController::class, 'handle'])->name('shiprocket.webhook');
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/how-to-order', 'how_to_order')->name('how_to_order');
...
Route::post('/shiprocket/track', [OrderController::class, 'shiprocket_track'])->name('shiprocket.track');
